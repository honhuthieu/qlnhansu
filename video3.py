...
def process_frame(frame_rgb, img_rgb):
...
while True:
    ...
    if time_elapsed > 1.0 / frame_rate:
        ...
        # Use concurrent.futures to process images in parallel
        with concurrent.futures.ThreadPoolExecutor() as executor:
            future_to_image = {executor.submit(process_frame, frame_rgb, img_rgb): img_rgb for img_rgb in images}
